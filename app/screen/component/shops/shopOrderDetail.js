...
const ShopOrderDetailScreen = (props) => {
  ...
  return (
    <GradientBackground>
      ...
      {/*<Image style={style.productImage} source={{uri:productDetails.image}}/>*/}

      {/*<ScrollView style={{flex:1}}>*/}
      {/*    <View style={{flexDirection:'row',marginTop:hp(1),paddingLeft:wp(1)}}>*/}
      {/*        {rupeesIcon()}*/}
      {/*        <Text style={{fontSize:normalize(25)}}>{productDetails?.amount}</Text>*/}
      {/*    </View>*/}
      ...
      {/*        <Text style={style.valueStyle}>{productDetails?.productName}</Text>*/}
      {/*        <View style={{height:hp(0.08),marginTop:hp(1),backgroundColor:'gray'}}/>*/}
      {/*    </View>*/}
      {/*    <View>*/}
      ...
      {/*            <Text style={style.valueStyle}>{productDetails?.size}</Text>*/}
      {/*            <View style={{height:hp(0.08),marginTop:hp(1),backgroundColor:'gray'}}/>*/}
      {/*        </View>*/}
      {/*        <View>*/}
      {/*            <Text style={style.titleHeading}>Qty</Text>*/}
      {/*            <Text style={style.qtyBtnText}>{productDetails.quantity}</Text>*/}
      {/*            <View style={{height:hp(0.08),marginTop:hp(1),backgroundColor:'gray'}}/>*/}
      {/*        </View>*/}
      {/*        <AppButton title={productDetails?.status?'Delivered':'Check as Delivered'} onPress={()=>{*/}
      {/*            updateOrderDeliverStatus()*/}
      {/*        }}/>*/}
