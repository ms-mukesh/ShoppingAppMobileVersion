    ...
    <View style={{ flex: 1, backgroundColor: color.white }}>
              ...
              {currentColorIndex !== null ? (
                ...
                >
                  <View style={{ flex: 1, width: wp(100) }}>
                    {/*<Image style={style.productImage} source={{ uri: currentImages }} />*/}
                    <FastImage
                      style={style.productImage}
                      source={{
                        uri: currentImages,
            ...
            >
              <View
                style={{
                  ...
                  borderRadius: hp(1),
                  height: hp(5),
                  backgroundColor: '#5881e6',
                }}
              >
                <Text style={{ fontSize: normalize(15), fontWeight: '700' }}>SHARE</Text>
              </View>
            </TouchableOpacity>
          </View>
        )}
      ...
      {productDetails?.category?.name?.toLowerCase() === 'saree' ? (
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
            ...
            >
              <View
                style={[
                  style.btnStyle,
                  { backgroundColor: 'rgba(206,81,171,0.71)', width: wp(40) },
                ]}
              >
                <Text style={style.btnText}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
          ...
          >
            <View
              style={[style.btnStyle, { backgroundColor: 'rgba(206,81,171,0.71)', width: wp(40) }]}
            >
              <Text style={style.btnText}>
                {isProductAvaliableInCart ? 'REMOVE FROM CART' : 'ADD TO CART'}
              </Text>
