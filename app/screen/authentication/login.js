...
const LoginScreen = (props) => {
  ...
  console.log('login props', props.route);
            ...
            <AppButton
              ...
              onPress={() => {
                ...
                dispatch(memberLogin(userdata, props.navigation)).then(async (res) => {
                  if (res) {
                    dispatch(addFCMTokenToDb(res?.fcmToken)).then((res) => {
                      if (res) {
                        if (productId === null) {
                          if (fromPopUp) {
                            props.navigation.dispatch(
                              CommonActions.reset({
                                ...
                                routes: [
                                  {
                                    name: 'ShopOwnerRequestScreen',
                                    params: { fromPopUp: fromPopUp },
                                  },
                                ],
                              })
                            );
                              ...
                              routes: [
                                {
                                  ...
                                  params: {
                                    productId: productId
                                      .toString()
                                      .substring(1, productId.toString().length),
                                    productImage: null,
                                    price: 0,
                                    productName: '',
